...
| **Jedna položka faktúry s ks = 25 531** | Alza 25. 7., „Chladicí podložka pro psy" — parser jej zle prečítal počet kusov (25 531 ks à 319 Kč). Peniaze to NEKAZÍ (suma riadku je 319 Kč a všetko sa sčítava zo súm), je to len nezmyselné číslo v stĺpci ks. Parser aj Jarvis sú od 20. 8. ošetrené; tento jeden riadok v DB opravím na ks = 1, keď povieš — je to tvoj finančný záznam, tak ho neprepisujem bez opýtania. |
