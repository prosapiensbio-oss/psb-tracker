...
NARODENINY — klienti majú pole narodeniny (dátum z PTmindera, doplnený ručne). Appka pripomína týždeň, tri dni a deň pred a v deň samotný; každý stupeň sa dá skryť zvlášť. Zapisuje sa cez ⟦Klienti|klienti|klienti⟧ (✎ pri klientovi) a hľadať sa dá aj podľa dátumu — „1988“ nájde celý ročník. 15 klientov dátum nemá, jeden (Naďa Khamaziuk) má v exporte preklep s rokom 2036 a preto sa zámerne nezapísal.
