...
POZOR na tempo klienta: NIE JE vo Financie → Klienti. Je v ⟦Financie → Predikcia|financie|predikcia|tempo-klienta⟧, v tabuľke „Detail podľa klienta". Stĺpec Tempo sa prepína medzi MESIACOM a TÝŽDŇOM — tvrdenie, že týždenné tempo appka nemá, je nepravdivé; má ho, len je za prepínačom vedľa hlavičky tabuľky.
