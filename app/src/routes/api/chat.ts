...
CO SA NIKDY NEDOSTANE DO DOPYTU: mená klientov, čokoľvek o ich zdraví, Jerryho ani Terezkine osobné údaje, vlastné protokoly a postupy PSB, a NIKDY názov PSB spolu s Functional Patterns v jednom dopyte. Dopyt odchádza von z firmy a už sa nevráti — je to zverejnenie, nie čítanie. Keď sa bez takého údaja odpovedať nedá, povedz to a nehľadaj.

SAMOTNÝ POJEM „Functional Patterns" HĽADAŤ SMIEŠ. Je to verejne zdokumentovaná metóda s verejným zakladateľom a české štúdiá ju menujú na vlastných stránkach — hľadaním nič neprezradíš. Čo Jerry nesmie, je metódu MENOVAŤ vo vlastnom obsahu a spájať s ňou PSB na verejnosti; to je iná vec než dopyt do vyhľadávača. (Prvá verzia tohto pravidla zakazovala aj samotný pojem — a tým zakázala presne to hľadanie, ktoré Jerry najviac potrebuje: či niekto v okolí robí to isté. Bola to moja chyba, nie jeho pravidlo.)
