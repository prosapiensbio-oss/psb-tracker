...
export function buildAiContext(
    ...
    return {
      ...
      webObsah: {
        poznamka: WEB_STRANKY.length
          ...
          : "Text webu sa ešte nestiahol. NEODPOVEDAJ, že o obsahu webu nič nevieš — v Údaje → Napojenia je karta „Text webu“ a treba stlačiť Prečítať web. Prázdna tabuľka nie je dôkaz.",
  ...
  return {
    ...
    rezerva: rezerva
      ? {
          poznamka: "Koľko mesiacov firma ustojí BEZ JEDINEJ TRŽBY: všetko, čo má (účet + hotovosť + bitcoin), delené priemerným break-evenom za pol roka. Toto je dlaždica „Rezerva“ na obrazovke Dnes a jediné miesto, odkiaľ sa rezerva smie brať — NEPOČÍTAJ si ju sám zo stavu hotovosti a NEHOVOR, že ju appka nepočíta. Cieľ sú 3 mesiace a je v poli „cielMesiacov“. Koľko korún do neho chýba, je v poli „chybaDoCielaCzk“ — PREČÍTAJ ho, nikdy si ten rozdiel nepočítaj sám; 18. 8. 2026 si na tú istú otázku dvakrát vyrátal iné číslo. „chybaDoCielaCzk: 0“ znamená, že rezerva je nad cieľom. „uplna: false“ znamená, že stav účtu a hotovosti nikto nezapísal a ráta sa len bitcoin — číslo je vtedy NIŽŠIE než skutočnosť a treba to povedať. Účet sa berie z hlavičky posledného bankového výpisu; ručne sa zapisuje už len hotovosť — v Peniaze → Cashflow, karta „Kde tie peniaze sú“.",
    ...
    odmlcani: (() => {
      ...
      return {
        poznamka: "Aktívni klienti zo segmentu Anchor alebo Stabilný, ktorí 14+ dní netrénovali A NEMAJÚ dohodnutý budúci termín v kalendári. Toto je dlaždica „Odmlčaní“ na obrazovke Dnes a JEDINÁ platná definícia toho slova — nepočítaj si vlastný zoznam z registra ani z posledných tréningov, register obsahuje aj iné veci (napr. otázku „je toto duch“) a vyjde ti iné číslo. 14 dní nie je náhoda: klient bez tréningu 14+ dní odchádza šesťkrát častejšie (48 % vs 8 %).",
        spolu: zoznam.length,
        pctAktivnych: (() => {
